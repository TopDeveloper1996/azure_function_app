...
def reconciliation_continuous_learning() -> None:
    ...
    job_id = "main-job-reconciliation-continuous-learning-" + "{:%Y-%m-%d-%H-%M-%S}".format(datetime.now())
        ...
        if len(customer_ids):
            ...
            for customer_id  in customer_ids:
                ...
                add_task(
                    ...
                    job_id=job_id,
                    command=command,
                    name=f"{customer_id}_reconciliation_continuous_learning",
                    logs_path_prefix=f'{customer_id}_reconciliation_continuous_learning',
                    environment_variables={"CUSTOMER_ID": customer_id}
                )
                print(f'reconciliation continuous learning started for - {customer_id}') 
...
#               use_monitor=False) 
# def ReconciliationContinuousLearning(myTimer: func.TimerRequest) -> None:
#     if myTimer.past_due:
#         logging.info('The timer is past due!')

#     logging.info('Python timer trigger function executed.')
#     reconciliation_continuous_learning()